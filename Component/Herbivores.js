...
import { AnimalsList, AnimalsList2, categories1,colors } from '../Data/Constant';
...
const Herbivores = () => {
  ...
  return (
   <View style={{flex:1,backgroundColor:"#011430"}}>
    ...
    <View style={{position:"absolute",marginTop:50,paddingLeft:5}}>
      <Text style={{fontSize:40,color:"white",paddingTop:10}}>Herbivores Animals</Text>
    ...
    <View>
			<FlatList
				...
				renderItem={({ item }) => (
					<Pressable
		onPress={()=>navigation.navigate("AnimalSlide2",{item:item})}
						style={{
